...
echo "Test Case 3: particles=10000 dt=0.1 steps=500 print_every=100 block_size=256" >> $OUTPUT
...
echo "Test Case 2: particles=1000 dt=1 steps=1000 print_every=50" >> $OUTPUT
./nbody_cpu 1000 1 1000 50 >> $OUTPUT
echo "" >> $OUTPUT

echo "Test Case 3: particles=10000 dt=0.1 steps=500 print_every=100" >> $OUTPUT
